...
widget(Pid) ->
    ...
    gs:frame(packer, Win,[{packer_x, [{stretch,1,500},{stretch,1,100,500},{stretch,1,100,500}]},
			  {packer_y, [{stretch,10,100,120},{stretch,1,15,15},{stretch,1,15,15}]}]),
    gs:create(editor,editor,packer, [{pack_x,1},{pack_y,{1,2}},{vscroll,right}]),
    gs:create(entry, entry, packer, [{pack_x,1},{pack_y,3},{keypress,true}]),
